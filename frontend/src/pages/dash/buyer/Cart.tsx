      ...
      {!loading && !error && cart && cart.items.length === 0 && (
        <Card>
          <p className="text-sm text-slate-500">
            Keranjang kosong.{' '}
            <Link to="/catalog" className="font-medium text-teal-700">
              Jelajahi katalog
            </Link>
            .
          </p>
        ...
        <>
              ...
              <Card key={item.product.id}>
                <div className="flex items-center justify-between gap-4">
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-sm text-slate-500">{formatRupiah(item.product.price)}</p>
                  </div>
                  ...
                  <p className="w-28 flex-shrink-0 text-right text-sm font-semibold text-slate-900">
          ...
          <Card>
            <div className="flex items-center justify-between">
              ...
              <p className="text-lg font-bold text-slate-900">{formatRupiah(cart.subtotal)}</p>
            </div>
